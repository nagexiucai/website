...
class Official extends Bra {
    ...
    public function __construct()
    {
        ...
        $this->content = "<div class='fullscreen'><p>Waiting for More...</p><hr/><p>me@nagexiucai.com</p><div id='logo'></div><div id='menu'></div><div id='show'>{{message}}</div><div id='friend'></div></div>";
